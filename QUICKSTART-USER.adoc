= Tradeunionist.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/TradeUnionist.jl
cd TradeUnionist.jl
...
* https://github.com/hyperpolymath/TradeUnionist.jl/issues — report bugs
